...
function Guide ()
    ...
    SetFocusArea(Config.FirstCam.x, Config.FirstCam.y, Config.FirstCam.z, Config.FirstCam.x, Config.FirstCam.y, Config.FirstCam.z)
    ...
    SetFocusArea(Config.SecondCam.x, Config.SecondCam.y, Config.SecondCam.z, Config.SecondCam.x, Config.SecondCam.y, Config.SecondCam.z)
    ...
    SetFocusArea(Config.ThirdCam.x, Config.ThirdCam.y, Config.ThirdCam.z, Config.ThirdCam.x, Config.ThirdCam.y, Config.ThirdCam.z)
    ...
    SetFocusArea(Config.FourthCam.x, Config.FourthCam.y, Config.FourthCam.z, Config.FourthCam.x, Config.FourthCam.y, Config.FourthCam.z)
